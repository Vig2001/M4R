...
Copy into latex
```{r}
latex_table <- xtable(summary_stats[, c('VISITNUM', 'label')],
                      caption = 'Mean, Standard Deviation, and Sample Size of NSAA Total Score by Visit Number',
                      label = 'tab:nsaa_stats',
                      align = c('l', 'l', 'l'),  # Alignment of columns: left, left
                      include.rownames = FALSE)

# Print the LaTeX table code
print(latex_table, type = 'latex', comment = FALSE, sanitize.text.function = function(x) {x})
```
