...
treatment_effect_fn <- function(data, num_bootstraps){
  ...
  for (i in 1:num_bootstraps){
    ...
    selected_patients <- sample(unique(rs_1005_nsaa$USUBJID), size = num_patients / 2)
...
treatment_effect <- 5 # significant treatment effect

# Using rough numbers from nsaa_total_gls and previous studies
# this is specifically tailored to VISIT being 12 weeks apart
intercept <- 18.9 # Replace with actual intercept
visit_coef <- 
visit_squared_coef <- 0 
