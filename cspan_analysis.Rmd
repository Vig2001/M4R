...
rs_1005_nsaa$VISIT <- rs_1005_nsaa$VISIT - mean(rs_1005_nsaa$VISIT)
...
# centre visit in the dataset <- the correlation under visit is just the correlation between visit and the intercept.
nsaa_total_gls_sum <- summary(nsaa_total_gls)
print(nsaa_total_gls_sum)
