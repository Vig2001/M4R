...
```
These plots show that when we apply scale=TRUE adding the components equally makes sense (the distribution of loadings around each component is ), but what is currently being done is not accounting for the variances of each component! maybe plot this when scale=FALSE.
