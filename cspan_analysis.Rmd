...
# Assuming X0 is your data frame and it's already loaded and processed
...
mvarplot <- ggplot(feature_stats, aes(x = prop_mean, y = variance, label = feature)) +
  ...
  geom_line(aes(x = mean_range, y = bernoulli_variance, color = " (x2) Bernoulli Mean-Variance Relationship"), linetype = "dashed") + # Expected Bernoulli relationship
...
my_screeplot <- fviz_screeplot(pca_facto, addlabels = TRUE, ylim = c(0, 100), 
               main = "Scree Plot")
ggsave("plots/scree_plot.png", my_screeplot, width=10, height=8, dpi=300)
...
ggsave("plots/biplot.png", my_biplot, width = 10, height = 8, dpi = 300)
