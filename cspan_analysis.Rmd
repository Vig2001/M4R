...
>>>>>>> 126a0cf (Updated Comments After 01/03 Meeting)
# add grey bard to the bottom of the plot to show how many individuals at each time point
# or do Klaman filter to perform dynamic PCA !!
```
...
# model would be RSORRES ~ 1 + (time in weeks - check for each visitnum) + (time in weeks) ** 2 + AR(1)
